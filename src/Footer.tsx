            ...
            <Row>
                <Col xs={12} md={4} lg={3}>
                    ...
                    <ul className='list-unstyled'>
                        <li><h6>Find A Store</h6></li>
                        <li><h6>Become A Member</h6></li>
                        <li><h6>Send Us Feedback</h6></li>
                    </ul>
                </Col>
                <Col xs={12} md={4} lg={3}>
                    ...
                    <ul className='list-unstyled'>
                        ...
                        <li><h6>Order Status</h6></li>
                        <li><h6>Delivery</h6></li>
                        <li><h6>Returns</h6></li>
                        <li><h6>Payment Options</h6></li>
                        <li><h6>Contact Us On Nike.com Inquiries</h6></li>
                        <li><h6>Contact Us On All Other Inquiries</h6></li>
                    </ul>
                </Col>
                <Col xs={12} md={4} lg={3}>
                    <h6 className='mt-3'><b>Company</b></h6>
                    <ul className='list-unstyled'>
                        <li><h6>About Nike</h6></li>
                        <li><h6>News</h6></li>
                        <li><h6>Careers</h6></li>
                        <li><h6>Investors</h6></li>
                        <li><h6>Sustainability</h6></li>
                    </ul>
                </Col>
